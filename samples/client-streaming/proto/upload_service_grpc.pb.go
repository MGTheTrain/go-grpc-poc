...
func (c *fileUploadServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (FileUploadService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileUploadService_ServiceDesc.Streams[0], "/FileUploadService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *fileUploadServiceUploadFileClient) Send(m *FileChunk) error {
...
func (x *fileUploadServiceUploadFileServer) Recv() (*FileChunk, error) {
	m := new(FileChunk)
